  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', overflow: 'hidden', position: 'relative' }}>
      ...
      <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '24px 48px', position: 'relative', zIndex: 1 }}>
        ...
        <a href="/auth/google" style={{ background: 'var(--accent)', color: '#000', padding: '8px 20px', borderRadius: 99, fontWeight: 600, fontSize: 13, fontFamily: 'var(--font-display)' }}>
          Try free →
        </a>
      </nav>
      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '80px 24px 60px', textAlign: 'center', position: 'relative', zIndex: 1 }}>
        ...
        <a href="/auth/google" style={{ display: 'inline-flex', alignItems: 'center', gap: 12, background: '#fff', color: '#000', padding: '16px 32px', borderRadius: 99, fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 15, transition: 'all 0.2s' }}
